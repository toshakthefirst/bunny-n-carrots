...
function spawnCarrots(){
    ...
    for(var x = 228;x<879;x =x+30){
         carrot = createSprite(x,140,10,10);
        carrot.shapeColor = "orange";
        carrot.addImage("carrot",carrotImage);
        carrot.scale = 0.09
    }
    for(var x = 228;x<759;x =x+30){
        carrot = createSprite(x,411,10,10);
        carrot.shapeColor = "orange";
        carrot.addImage("carrot",carrotImage);
        carrot.scale = 0.09
    }
    for(var y = 80;y<420;y =y+30){
         carrot = createSprite(286,y,10,10);
        carrot.shapeColor = "orange";
        carrot.addImage("carrot",carrotImage);
        carrot.scale = 0.09
    }
    for(var y = 80;y<420;y =y+30){
         carrot = createSprite(799,y,10,10);
        carrot.shapeColor = "orange";
        carrot.addImage("carrot",carrotImage);
        carrot.scale = 0.09
    }
    for(var y = 214;y<329;y =y+30){
         carrot = createSprite(617,y,10,10);
        carrot.shapeColor = "orange";
        carrot.addImage("carrot",carrotImage);
        carrot.scale = 0.09
    }
    for(var y = 214;y<329;y =y+30){
     ...
     for(var y = 214;y<329;y =y+30){
         carrot = createSprite(368,y,10,10);
        carrot.shapeColor = "orange";
        carrot.addImage("carrot",carrotImage);
        carrot.scale = 0.09
    }
